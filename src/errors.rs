...
error_chain! {
    errors {
        LBankError(response: LBankContentError) {
            description("LBank API error")
            display("LBank API error: code={}, msg={}", response.code, response.msg)
        }
